...
public class Parcare
{
    ...
    public static void CreareLocParcare(ZonaParcare zona, int idLoc, TipLocParcare tipLoc)
    {
        LocDeParcare loc;
    ...
    public static void ModificareTipLocParcare(ZonaParcare zona, int idLoc, TipLocParcare tipNou)
    {
    ...
    public static void StergereLocParcare(ZonaParcare zona, int idLoc)
    {
        var loc = zona.ListLocDeParcare
            .FirstOrDefault(l => l.IdLocDeParcare == idLoc);
